      ...
      <div className="container mx-auto p-4">
        ...
        <div className="overflow-x-auto">
          {filteredList.length > 0 ? (
            <table id="admin-beneficiaries-table" className="min-w-full bg-white border-collapse shadow-lg">
        ...
        <button onClick={() => generatePdf("admin-beneficiaries-table","admin-beneficiaries-pdf")} className="w-full bg-blue-600 text-white p-2 rounded mt-4 hover:bg-gray-800">Download PDF</button>
      </div>
    );
  };
