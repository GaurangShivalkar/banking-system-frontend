        ...
        <section id="about-us" className="py-14 lg:py-24 relative ">
            <div className="container mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="backdrop-blur-md border border-gray-200 rounded-lg p-6 bg-black/30" >
                    ...
                    <div className="backdrop-blur-md border border-gray-200 rounded-lg p-6 bg-black/30">
                        ...
                        <p className="text-neutral-grayish-blue mb-4">
                            Founded in 1990, ENQ Bank has grown to become a leading financial institution, serving millions of customers worldwide. Our journey has been marked by a commitment to excellence and a passion for innovation.
                        </p>
                        <h3 className="text-2xl font-semibold mb-4 text-primary-dark-blue">Our Team</h3>
                        <p className="text-neutral-grayish-blue">
                            Our team of experienced professionals is dedicated to providing top-notch banking services. We believe in fostering a collaborative and inclusive environment where everyone can thrive.
                        </p>
                    </div>
                </div>
            </div>
